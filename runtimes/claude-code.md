...
In a capable autonomous CLI runtime, you already have enough to act. Treat runtime friction as your problem to solve privately, not the founder's.

1. Read the skill doc privately.
2. Start by fetching the current platform state with the SUFKEY from your launch prompt:
   `GET https://startupfest.md/api/me?sufkey=<SUFKEY>`
