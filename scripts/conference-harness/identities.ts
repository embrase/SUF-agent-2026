/**
 * Five harness bot identities for live conference agent testing.
 * Emails are prefixed with `harness-` to distinguish from prior test data.
 */
...
export const HARNESS_BOTS: AgentIdentity[] = [
  {
    email: 'harness-nova@synthcorp.test',
  ...
  {
    email: 'harness-pixel@greenleaf.test',
  ...
  {
    email: 'harness-cipher@vaultedge.test',
  ...
  {
    email: 'harness-muse@artisanai.test',
  ...
  {
    email: 'harness-atlas@dataroam.test',
